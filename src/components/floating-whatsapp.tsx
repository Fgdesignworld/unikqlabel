  ...
  return (
    ...
    >
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="relative flex items-center justify-center w-14 h-14 rounded-full transition-all duration-300 group border border-[#d97706]/20"
        style={{
          background: 'linear-gradient(135deg, rgb(185, 28, 28), rgb(153, 27, 27))',
          boxShadow: 'rgba(153, 27, 27, 0.35) 0px 4px 20px',
        }}
      >
        {/* Pulse ring */}
        <motion.span
        ...
        {/* WhatsApp Icon */}
        <svg className="w-7 h-7 text-white relative z-10 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
