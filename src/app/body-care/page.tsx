...
const SLUG = "body-care"
const FALLBACK_SLUG = "men"

export default function BodyCarePage() {
  useSeo({ pageType: "page", pageSlug: "body-care", fallbackTitle: "Premium Body Care — Aarvia" })
  ...
  const perks = [
    { icon: Leaf, text: "Skin Radiance" },
    { icon: Sparkles, text: "Botanical Extracts" },
    { icon: Award, text: "Daily Rituals" },
  ]
  ...
  return (
    <main className="min-h-screen" style={{ background: "#FDFBF7" }}>
      ...
      <PageHeader
        ...
        subtitle="Pure, plant-derived body washes, body oils, and spa-quality treatments to hydrate and nurture the body."
      ...
      <section className="px-4 pb-24">
        <div className="container mx-auto max-w-7xl">
          <ProductFilters
            products={allItems}
            loading={loading}
            searchPlaceholder="Search body care collection…"
            subcategories={subCats}
            allLabel="All Body Care"
            ...
            emptyMessage="Body Care Collection coming soon."
          />
        </div>
      </section>
