...
const SLUG = "kids-care"
const FALLBACK_SLUG = "unisex"

export default function KidsCarePage() {
  useSeo({ pageType: "page", pageSlug: "kids-care", fallbackTitle: "Premium Kids Care — Aarvia" })
  ...
  const perks = [
    { icon: Leaf, text: "Ultra Gentle" },
    { icon: Sparkles, text: "Plant Derived" },
    { icon: Award, text: "Safe & Hypoallergenic" },
  ]
  ...
  return (
    <main className="min-h-screen" style={{ background: "#FDFBF7" }}>
      <Navbar />
      <PageHeader
        title="Kids Care Solutions"
        subtitle="Specially formulated, clean, and gentle plant-based personal care for the delicate skin and hair of little ones."
        backgroundImage="https://images.unsplash.com/photo-1515488042361-404e9250afef?q=80&w=1200&auto=format&fit=crop"
      />
      ...
      <section className="px-4 pb-24">
        <div className="container mx-auto max-w-7xl">
          <ProductFilters
            products={allItems}
            loading={loading}
            searchPlaceholder="Search kids care collection…"
            subcategories={subCats}
            allLabel="All Kids Care"
            ...
            emptyMessage="Kids Care Collection coming soon."
          />
        </div>
      </section>
